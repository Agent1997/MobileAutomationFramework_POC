...
public class Gestures {
    ...
    private static final int waitDurationInSeconds = 10;
    ...
    public  void tapByElement(MobileElement element) {
       WaitsStatic.waitForElementToBeInteractalbe(driver,element,waitDurationInSeconds);
    ...
    public void tapByElementLocator(By elementLocator) {
        WaitsStatic.waitForElementLocatedByToBeInteractalbe(driver,elementLocator,waitDurationInSeconds);
